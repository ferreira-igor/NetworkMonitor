...
- To reset the WiFi credentials or reconfigure the device, press and hold the reset button (GPIO 13) while powering on the ESP32. The device will reset the WiFi credentials and reopen the configuration portal, allowing you to re-enter the settings.
...
- `/info`: Provides information about the device.
